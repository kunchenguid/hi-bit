...
For playable-game requests, verify that the worker reads the `create-game` skill, uses its loop/input/collision boilerplate, and combines it with `game-assets` when the game needs generated sprites.
