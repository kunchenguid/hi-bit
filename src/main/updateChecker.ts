...
// Hi-Bit ships through GitHub Releases (and the Homebrew cask built from them in
// kunchenguid/homebrew-tap), so "is there a newer version" is answered by the
// public GitHub releases API. There is no in-app auto-updater; the indicator
// just points the grown-up at the Homebrew upgrade command and the release page.
