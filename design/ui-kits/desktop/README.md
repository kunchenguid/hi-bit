...
- Codex provider connection, profile selection, profile switching, profile-level creation management, first-message idea sparks, and live preview Play affordances are not part of this click-thru prototype.
