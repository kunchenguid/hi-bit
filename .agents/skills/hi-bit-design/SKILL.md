...
4. **Reference current product surfaces** in `src/renderer/src/screens/` for Codex auth, profile gate, project picker, and chat workspace flows.
...
- A new screen for the Hi-Bit app (Codex auth, profile gate, project picker, chat workspace, onboarding)
